...
public Boolean Pronadji(String _username, String pass) {
		...
		try
		{
			_u =(Uposlenik) criteria.add(Restrictions.eq("password", pass)).add(Restrictions.eq("username",_username)).uniqueResult();
